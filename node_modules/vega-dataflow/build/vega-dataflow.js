(function (global, factory) {
  ...
  function changeset() {
    ...
    return {
      ...
      insert(t) {
        let d = vegaUtil.array(t), i = 0, n = d.length;
        for (; i<n; ++i) add.push(d[i]);
        return this;
      },
      remove(t) {
        let a = vegaUtil.isFunction(t) ? remp : rem,
            d = vegaUtil.array(t), i = 0, n = d.length;
        for (; i<n; ++i) a.push(d[i]);
        return this;
      },
      modify(t, field, value) {
        let m = {field: field, value: vegaUtil.constant(value)};
  ...
  function onStream(df, stream, target, update, params, options) {
    let opt = vegaUtil.extend({}, options, SKIP$1), func, op;
